  ...
  return (
    ...
    >
      ...
      <TouchableOpacity
        ...
        onPress={() => router.push(paths.settingsAccount as Href)}
        activeOpacity={0.7}
      >
        {showProfilePicture && (
      ...
      <View style={styles.section}>
        ...
        <ListGroup>
          <ListItem
            ...
            title="Novinky"
            onPress={() => router.push(paths.novinky as Href)}
          />
          {extraEnabled && (
            <ListItem
              icon={
              ...
              onPress={() => router.push(paths.substitution as Href)}
            />
          )}
          <ListItem
            icon={
            ...
            title="Učitelé"
            onPress={() => router.push(paths.teachersList as Href)}
          />
          <ListItem
            icon={
              <Ionicons
            ...
            title="Učebny"
            onPress={() => router.push(paths.roomsList as Href)}
          />
          <ListItem
            icon={
            ...
            onPress={() => router.push(paths.prichody as Href)}
          />
          <ListItem
            icon={
              <Ionicons
            ...
            title="Omluvný list"
            onPress={() => router.push(paths.omluvnyList as Href)}
          />
          <ListItem
            icon={
            ...
            title="Dokumenty"
            onPress={() => router.push(paths.dokumenty as Href)}
          />
        </ListGroup>
      </View>
      ...
      <View style={styles.section}>
        <ListGroup>
          <ListItem
            ...
            title="Nastavení"
            onPress={() => router.push(paths.settings as Href)}
            isLast={true}
          />
        </ListGroup>
      </View>
