...
import {
  ...
  drawerPaths,
  useLayoutPaths,
} from '@/lib/layoutPaths';

function DrawerContent(props: React.ComponentProps<typeof DrawerItemList>) {
  ...
  const handleAccountPress = () => {
    router.push(paths.settingsAccount as Href);
  };
...
export default function DrawerLayout() {
  ...
  return (
    <LayoutPathsProvider paths={drawerPaths}>
      <Drawer
